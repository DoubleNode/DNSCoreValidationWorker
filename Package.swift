...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNode/DNSBlankWorkers.git", from: "1.4.5"),
        .package(url: "https://github.com/DoubleNode/DNSCore.git", from: "1.4.10"),
        .package(url: "https://github.com/DoubleNode/DNSCorePasswordStrengthWorker.git", from: "1.4.0"),
        .package(url: "https://github.com/DoubleNode/DNSCrashWorkers.git", from: "1.4.4"),
        .package(url: "https://github.com/DoubleNode/DNSError.git", from: "1.4.2"),
        .package(url: "https://github.com/DoubleNode/DNSProtocols.git", from: "1.4.11"),
    ],
    targets: [
