...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNode/DNSCorePasswordStrengthWorker.git", from: "1.2.1"),
        .package(url: "https://github.com/DoubleNode/DNSCrashWorkers.git", from: "1.2.1"),
    ],
    targets: [
